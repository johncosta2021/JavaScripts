...
function Aula_17(){
    ...
    return(
        <>
        <Nota num={1} nome={"nota1"} nota={notas.nota1} setNota={handleSetNotas}></Nota>
        <Nota num={2} nome={"nota2"} nota={notas.nota2} setNota={handleSetNotas}></Nota>
        <Nota num={3} nome={"nota3"} nota={notas.nota3} setNota={handleSetNotas}></Nota>
        <Nota num={4} nome={"nota4"} nota={notas.nota4} setNota={handleSetNotas}></Nota>
        <Resultado somaNotas={parseFloat(notas.nota1)+parseFloat(notas.nota2)+parseFloat(notas.nota3)+parseFloat(notas.nota4)}></Resultado>
        </>
    )
}

export default Aula_17